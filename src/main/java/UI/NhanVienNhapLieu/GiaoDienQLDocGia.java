 ...
 * @author tinhlam
 */
public class GiaoDienQLDocGia extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GiaoDienQLDocGia
     *
     * @param parent
     */
    public GiaoDienQLDocGia(JFrame parent) {
        this.parent = parent;
        initComponents();
        setup();
        loadDefaultList();
    ...
    void loadDefaultList() {
        ds = new DocGia().layDanhSach();
    }

    void renderTable() {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);
        model.setColumnIdentifiers(DocGia.getProperties());
        for (int i = 0; i < jTable1.getModel().getColumnCount(); i++) {
            jTable1.getColumnModel().getColumn(i).setHeaderRenderer(headerRenderer);
            jTable1.getColumnModel().getColumn(i).setPreferredWidth(150);
        }
    ...
    private void initComponents() {
        ...
        inTheThuVienBtn = new javax.swing.JButton();
        ...
        inTheThuVienBtn.setBackground(new java.awt.Color(51, 102, 255));
        inTheThuVienBtn.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        inTheThuVienBtn.setForeground(new java.awt.Color(255, 255, 255));
        inTheThuVienBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ms_word.png"))); // NOI18N
        inTheThuVienBtn.setText("In thẻ");
        inTheThuVienBtn.setBorder(null);
        inTheThuVienBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inTheThuVienBtnActionPerformed(evt);
            }
        });
        ...
        centerTopPanelLayout.setHorizontalGroup(
            ...
            .addGroup(centerTopPanelLayout.createSequentialGroup()
                ...
                .addComponent(inTheThuVienBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(15, 15, 15))
        );
        centerTopPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, centerTopPanelLayout.createSequentialGroup()
                ...
                .addGroup(centerTopPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(soHieuTf, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3)
                    ...
                    .addComponent(inTheThuVienBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(32, 32, 32))
        );
    ...
    private void themBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themBtnActionPerformed
        GiaoDienThemDocGia form = new GiaoDienThemDocGia(this);
        form.setVisible(true);
    }//GEN-LAST:event_themBtnActionPerformed

    private void suaBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suaBtnActionPerformed
        int row = jTable1.getSelectedRow();
        GiaoDienSuaDocGia form = new GiaoDienSuaDocGia(this, (DocGia) ds.get(row));
        form.setVisible(true);
    ...
    private void timBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_timBtnActionPerformed
        if (soHieuTf.getText().equals("")) {
            ds = new DocGia().layDanhSach();
        } else {
            int soHieu = Integer.valueOf(soHieuTf.getText());
            ds = new DocGia().timKiemTheoSoHieu(soHieu);
        }
        renderTable();
    }//GEN-LAST:event_timBtnActionPerformed

    private void inTheThuVienBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inTheThuVienBtnActionPerformed
        int row = jTable1.getSelectedRow();
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "Dữ liệu chọn không hợp lệ");
            return;
        ...
        chooser.setDialogTitle("Chọn đường dẫn lưu file word");
        int op = chooser.showSaveDialog(this);
        String path = "";
        if (op == JFileChooser.APPROVE_OPTION) {
            path = chooser.getSelectedFile().toString();
            MayIn.xuatFileWord((DocGia) ds.get(row), path);
            JOptionPane.showMessageDialog(this, "Xuất file thành công");
        }
    }//GEN-LAST:event_inTheThuVienBtnActionPerformed
    ...
    private javax.swing.JButton inTheThuVienBtn;
