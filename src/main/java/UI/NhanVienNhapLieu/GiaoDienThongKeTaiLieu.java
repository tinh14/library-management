 ...
 * @author tinhlam
 */
public class GiaoDienThongKeTaiLieu extends javax.swing.JFrame {
    
    JFrame parent;
    ThongKe thongKe;
    DefaultTableCellRenderer headerRenderer;
    /**
     * Creates new form GiaoDienThongKeTaiLieu
     * @param parent
     */
    public GiaoDienThongKeTaiLieu(JFrame parent) {
        this.parent = parent;
        initComponents();
        setup();
    }
    ...
    private void renderTable() {
        ...
        model.setRowCount(0);
        ThongKeTaiLieu tk = (ThongKeTaiLieu)thongKe;
        model.setColumnIdentifiers(ThongKeTaiLieu.getProperties());
    ...
    private void initComponents() {
        ...
        topLb.setText("Thống Kê Tài Liệu");
    ...
    private void thongKeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_thongKeBtnActionPerformed
        ArrayList<LocalDate> dates = ThongKe.getMinMaxDate("ngayNhapKho", "TaiLieu");
        if (dates == null){
            return;
        }
        ...
        thongKe = new ThongKeTaiLieu(bd, kt).layThongKe();
        renderTable();
