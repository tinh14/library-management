...
public class ThuThu extends NhanVien {
    ...
    public ThuThu(String taiKhoan, String matKhau, String soChungMinh, String diaChi, String email, String soDienThoai, byte[] anhDaiDien, int soHieu, String ho, String ten, LocalDate ngaySinh) {
